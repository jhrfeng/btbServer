...
exports.addOrder = function (req, res, next) {
	...
	order1.userid = "58f1c351422a2d1b6e91ca99";
	order1.orderid = "00000000_08"; // 预存
	order1.pid = {"pid":"20170002", "name":"比特币套利基金半年", "shouyi":30.0, "week":180, "join":1000};
	order1.payAmount = 50000;
	order1.tradeno = "00000000_08";
	order1.outtrade = "00000000_08";
	order1.opendate = moment("2017-04-28").dayOfYear(180);
	order1.openAmount = 57397;
	order1.openStatus = "0";
