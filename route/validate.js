...
exports.addOrder = function (req, res, next) {
	...
	order1.orderid = "00000000_07"; // 预存
	order1.pid = {"pid":"20170003", "name":"比特币套利基金全年", "shouyi":40.0, "week": 365, "join":1000};
	order1.payAmount = 100000;
	order1.tradeno = "00000000_07";
	order1.outtrade = "00000000_07";
	order1.opendate = moment("2017-04-22").dayOfYear(365);
	order1.openAmount = 140000;
	order1.openStatus = "0";
	order1.created = moment("2017-04-22"); //购买日期
